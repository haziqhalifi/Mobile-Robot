...
// If your robot tracks the white floor instead of the black tape, change HIGH to LOW.
...
void loop() {
  ...
  if (currentMillis - lastSerialTime >= 500) { // Set to 500ms for faster debugging
